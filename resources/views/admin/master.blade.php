...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('website/img/title-image.png')}}" alt="AdminLTE Logo" class="brand-image border border-white img-circle elevation-3"
           style="opacity: 2">
      <span class="brand-text font-weight-light">Priyanshu Enterprises</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/crop/list" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Crop Registration</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/health/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Health Checkup</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/education/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Education</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/saving/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Saving Group</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/enterpreneur/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Marathi Enterpreneurs</p>
                </a>
              </li> 
            </ul>
          </li> --}}
